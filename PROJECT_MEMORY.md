...
The catalogue presents completed implementations with the label «Реализованный демо-проект» and contains their typed demo status, target audience, implemented functions, live URL, screenshots, tested scenarios and explicit independent-project limitations.
